Feature: Open pages
  ...
  Background: login and access the main page
    Given I fill the "usernameinput" field with "up*****"
    And  I fill the "passwordinput" field with "****"
    And I tap the "entrar" button
    And I expect the text "Área Pessoal" to be present
  ...
  Scenario: login and submit a bug report
    When I open the drawer
